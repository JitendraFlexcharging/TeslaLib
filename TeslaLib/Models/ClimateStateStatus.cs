...
namespace TeslaLib.Models
{
    ...
    //
    // In Oct 2019, a 2018 Model 3:
    // {"response":{"battery_heater":false,"battery_heater_no_power":null,"climate_keeper_mode":"off","defrost_mode":0,
    // "driver_temp_setting":22.2,"fan_status":0,"inside_temp":14.7,"is_auto_conditioning_on":false,"is_climate_on":false,
    // "is_front_defroster_on":false,"is_preconditioning":false,"is_rear_defroster_on":false,"left_temp_direction":690,
    // "max_avail_temp":28.0,"min_avail_temp":15.0,"outside_temp":14.0,"passenger_temp_setting":22.2,"remote_heater_control_enabled":false,
    // "right_temp_direction":690,"seat_heater_left":0,"seat_heater_rear_center":0,"seat_heater_rear_left":0,"seat_heater_rear_right":0,
    // "seat_heater_right":0,"side_mirror_heaters":false,"smart_preconditioning":false,"timestamp":1570006549991,"wiper_blade_heater":false}}
